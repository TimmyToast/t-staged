...
$(document).ready(function() {
    $(".buy-off-container #ctl00_globalMainContent_btnCheckout").attr("href", "/basket.htm"), flagSwap(), "undefined" != typeof toast_config && toast_config.in_sale === !0 ? $(".standard-pp").show() : $(".free-pp-and-returns").show(), "" === $.cookie("preset_filters") && $.removeCookie("preset_filters");
