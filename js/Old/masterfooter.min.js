...
_gaq.push(["_require", "inpage_linkid", pluginUrl]), _gaq.push(["_setAccount", "UA-1341106-1"]), _gaq.push(["_setDomainName", "toa.st"]), _gaq.push(["_setAllowLinker", !0]), _gaq.push(["_trackPageview"]),
    function() {
...
var _prum = [
    ["id", "58a5aa15f4bab53b1f7b23c6"],
    ["mark", "firstbyte", (new Date).getTime()]
];
! function() {
    var e = document.getElementsByTagName("script")[0],
        t = document.createElement("script");
    t.async = "async", t.src = "//rum-static.pingdom.net/prum.min.js", e.parentNode.insertBefore(t, e)
    ...
    var e = $(this).parents(".menu--dropdown");
    e.toggleClass("active", !e.hasClass("active"))
});
