                ...
                for (e.drawMonth = Z, e.drawYear = et, i = this._get(e, "prevText"), i = F ? this.formatDate(i, this._daylightSavingAdjust(new Date(et, Z - V, 1)), this._getFormatConfig(e)) : i, s = this._canAdjustMonth(e, -1, et, Z) ? "<a class='ui-datepicker-prev ui-corner-all' data-handler='prev' data-event='click' title='" + i + "'><span class='ui-icon ui-icon-circle-triangle-" + (q ? "e" : "w") + "'>" + i + "</span></a>" : Q ? "" : "<a class='ui-datepicker-prev ui-corner-all ui-state-disabled' title='" + i + "'><span class='ui-icon ui-icon-circle-triangle-" + (q ? "e" : "w") + "'>" + i + "</span></a>", n = this._get(e, "nextText"), n = F ? this.formatDate(n, this._daylightSavingAdjust(new Date(et, Z + V, 1)), this._getFormatConfig(e)) : n, a = this._canAdjustMonth(e, 1, et, Z) ? "<a class='ui-datepicker-next ui-corner-all' data-handler='next' data-event='click' title='" + n + "'><span class='ui-icon ui-icon-circle-triangle-" + (q ? "w" : "e") + "'>" + n + "</span></a>" : Q ? "" : "<a class='ui-datepicker-next ui-corner-all ui-state-disabled' title='" + n + "'><span class='ui-icon ui-icon-circle-triangle-" + (q ? "w" : "e") + "'>" + n + "</span></a>", o = this._get(e, "currentText"), r = this._get(e, "gotoCurrent") && e.currentDay ? J : L, o = F ? this.formatDate(o, r, this._getFormatConfig(e)) : o, l = e.inline ? "" : "<button type='button' class='ui-datepicker-close ui-state-default ui-priority-primary ui-corner-all' data-handler='hide' data-event='click'>" + this._get(e, "closeText") + "</button>", c = B ? "<div class='ui-datepicker-buttonpane ui-widget-content'>" + (q ? l : "") + (this._isInRange(e, r) ? "<button type='button' class='ui-datepicker-current ui-state-default ui-priority-secondary ui-corner-all' data-handler='today' data-event='click'>" + o + "</button>" : "") + (q ? "" : l) + "</div>" : "", d = parseInt(this._get(e, "firstDay"), 10), d = isNaN(d) ? 0 : d, h = this._get(e, "showWeek"), u = this._get(e, "dayNames"), p = this._get(e, "dayNamesMin"), f = this._get(e, "monthNames"), g = this._get(e, "monthNamesShort"), m = this._get(e, "beforeShowDay"), v = this._get(e, "showOtherMonths"), b = this._get(e, "selectOtherMonths"), y = this._getDefaultDate(e), w = "", k = 0; U[0] > k; k++) {
                    for (x = "", this.maxRows = 4, _ = 0; U[1] > _; _++) {
                        if (C = this._daylightSavingAdjust(new Date(et, Z, e.selectedDay)), S = " ui-corner-all", $ = "", X) {
                            ...
                            case 0:
                                $ += " ui-datepicker-group-first", S = " ui-corner-" + (q ? "right" : "left");
                                break;
                            case U[1] - 1:
                                $ += " ui-datepicker-group-last", S = " ui-corner-" + (q ? "left" : "right");
                                break;
                            default:
                        ...
                        for ($ += "<div class='ui-datepicker-header ui-widget-header ui-helper-clearfix" + S + "'>" + (/all|left/.test(S) && 0 === k ? q ? a : s : "") + (/all|right/.test(S) && 0 === k ? q ? s : a : "") + this._generateMonthYearHeader(e, Z, et, G, K, k > 0 || _ > 0, f, g) + "</div><table class='ui-datepicker-calendar'><thead><tr>", T = h ? "<th class='ui-datepicker-week-col'>" + this._get(e, "weekHeader") + "</th>" : "", N = 0; 7 > N; N++) P = (N + d) % 7, T += "<th" + ((N + d + 6) % 7 >= 5 ? " class='ui-datepicker-week-end'" : "") + "><span title='" + u[P] + "'>" + p[P] + "</span></th>";
                        for ($ += T + "</tr></thead><tbody>", j = this._getDaysInMonth(et, Z), et === e.selectedYear && Z === e.selectedMonth && (e.selectedDay = Math.min(e.selectedDay, j)), z = (this._getFirstDayOfMonth(et, Z) - d + 7) % 7, A = Math.ceil((z + j) / 7), D = X && this.maxRows > A ? this.maxRows : A, this.maxRows = D, I = this._daylightSavingAdjust(new Date(et, Z, 1 - z)), R = 0; D > R; R++) {
                            for ($ += "<tr>", M = h ? "<td class='ui-datepicker-week-col'>" + this._get(e, "calculateWeek")(I) + "</td>" : "", N = 0; 7 > N; N++) E = m ? m.apply(e.input ? e.input[0] : null, [I]) : [!0, ""], W = I.getMonth() !== Z, O = W && !b || !E[0] || G && G > I || K && I > K, M += "<td class='" + ((N + d + 6) % 7 >= 5 ? " ui-datepicker-week-end" : "") + (W ? " ui-datepicker-other-month" : "") + (I.getTime() === C.getTime() && Z === e.selectedMonth && e._keyEvent || y.getTime() === I.getTime() && y.getTime() === C.getTime() ? " " + this._dayOverClass : "") + (O ? " " + this._unselectableClass + " ui-state-disabled" : "") + (W && !v ? "" : " " + E[1] + (I.getTime() === J.getTime() ? " " + this._currentClass : "") + (I.getTime() === L.getTime() ? " ui-datepicker-today" : "")) + "'" + (W && !v || !E[2] ? "" : " title='" + E[2].replace(/'/g, "&#39;") + "'") + (O ? "" : " data-handler='selectDay' data-event='click' data-month='" + I.getMonth() + "' data-year='" + I.getFullYear() + "'") + ">" + (W && !v ? "&#xa0;" : O ? "<span class='ui-state-default'>" + I.getDate() + "</span>" : "<a class='ui-state-default" + (I.getTime() === L.getTime() ? " ui-state-highlight" : "") + (I.getTime() === J.getTime() ? " ui-state-active" : "") + (W ? " ui-priority-secondary" : "") + "' href='#'>" + I.getDate() + "</a>") + "</td>", I.setDate(I.getDate() + 1), I = this._daylightSavingAdjust(I);
                            $ += M + "</tr>"
                        }
    ...
    function (e) {
        ...
        if ("file:" == location.protocol && (l = "localhost"), e.load.ed = 1, o.hostname = l, o.origin = r || location.href, r && t.addClass("is-embedded"), "string" == typeof c && (c = c.split(/,\s*/)), c && "function" == typeof n && n(c, l)) o.logo && t.append(a("<a>", {
            ...
            e.bind("pause resume finish unload", function (e, i) {
                var s = -1;
                i.video.src && a.each([["org", "flowplayer", "drive"], ["org", "flowplayer", "my"]], function (e, t) {
        ...
        e.fn.bxSlider = function (n) {
            ...
            var r = e(window).width(),
                ...
                u = function () {
                    ...
                    a.loader.remove(), y(), "vertical" == a.settings.mode && (a.settings.adaptiveHeight = !0), a.viewport.height(p()), o.redrawSlider(), a.settings.onSliderLoad(a.active.index), a.initialized = !0, a.settings.responsive && e(window).bind("resize", q), a.settings.auto && a.settings.autoStart && R(), a.settings.ticker && M(), a.settings.pager && z(a.settings.startSlide), a.settings.controls && I(), a.settings.touchEnabled && !a.settings.ticker && W()
                },
                p = function () {
                    var t = 0,
                        s = e();
                ...
                O = function (e) {
                    if (a.working) e.preventDefault();
                        ...
                        a.touch.start.x = t.changedTouches[0].pageX, a.touch.start.y = t.changedTouches[0].pageY, a.viewport.bind("touchmove", H), a.viewport.bind("touchend", L)
                    }
                },
                H = function (e) {
                    var t = e.originalEvent,
        ...
        T.clearRect = function () {
            ...
            i(this, c([[1, 0, 0], [0, 1, 0], [e, t, 1]], this.m_), !1)
        }, T.rotate = function (e) {
            var t = b(e),
                s = v(e);
            i(this, c([[t, s, 0], [-s, t, 0], [0, 0, 1]], this.m_), !1)
        }, T.scale = function (e, t) {
            this.arcScaleX_ *= e, this.arcScaleY_ *= t, i(this, c([[e, 0, 0], [0, t, 0], [0, 0, 1]], this.m_), !0)
        }, T.transform = function (e, t, s, n, a, o) {
            i(this, c([[e, t, 0], [s, n, 0], [a, o, 1]], this.m_), !0)
        }, T.setTransform = function (e, t, s, n, a, o) {
            i(this, [[e, t, 0], [s, n, 0], [a, o, 1]], !0)
...
Tipped.Skins = {
    ...
    function (e) {
        ...
        function i(t, i) {
            function S(t) {
                if (!(rt() || e(t.target).closest(i.excludedElements, qt).length > 0)) {
                    var s, n = t.originalEvent ? t.originalEvent : t,
                        a = _ ? n.touches[0] : n;
                    return Bt = w, _ ? Qt = n.touches.length : t.preventDefault(), Dt = 0, It = null, Ht = null, Rt = 0, Mt = 0, Et = 0, Wt = 1, Ot = 0, Ft = ut(), Lt = gt(), at(), !_ || Qt === i.fingers || i.fingers === b || L() ? (ct(0, a), Ut = _t(), 2 == Qt && (ct(1, n.touches[1]), Mt = Et = bt(Ft[0].start, Ft[1].start)), (i.swipeStatus || i.pinchStatus) && (s = D(n, Bt))) : s = !1, s === !1 ? (Bt = x, D(n, Bt), s) : (lt(!0), null)
                }
            }
            ...
            function $(e) {
                ...
                if (Bt !== k && Bt !== x && !ot()) {
                    var s, n = _ ? t.touches[0] : t,
                        a = dt(n);
                    if (Yt = _t(), _ && (Qt = t.touches.length), Bt = N, 2 == Qt && (0 == Mt ? (ct(1, t.touches[1]), Mt = Et = bt(Ft[0].start, Ft[1].start)) : (dt(t.touches[1]), Et = bt(Ft[0].end, Ft[1].end), Ht = wt(Ft[0].end, Ft[1].end)), Wt = yt(Mt, Et), Ot = Math.abs(Mt - Et)), Qt === i.fingers || i.fingers === b || !_ || L()) {
            ...
            function z() {
                qt.unbind(Tt, S), qt.unbind(At, P), qt.unbind(Pt, $), qt.unbind(jt, T), zt && qt.unbind(zt, j), lt(!1)
            }
            ...
            function D(e, t) {
                var i = void 0;
                return F() || Q() ? i = I(e, t, h) : (q() || L()) && i !== !1 && (i = I(e, t, u)), it() && i !== !1 ? i = I(e, t, f) : st() && i !== !1 ? i = I(e, t, g) : tt() && i !== !1 && (i = I(e, t, p)), t === x && P(e), t === k && (_ ? 0 == e.touches.length && P(e) : P(e)), i
            }

            function I(t, c, d) {
                var m = void 0;
                if (d == h) {
                    if (qt.trigger("swipeStatus", [c, It || null, Dt || 0, Rt || 0, Qt]), i.swipeStatus && (m = i.swipeStatus.call(qt, t, c, It || null, Dt || 0, Rt || 0, Qt), m === !1)) return !1;
                    if (c == k && B()) {
                        if (qt.trigger("swipe", [It, Dt, Rt, Qt]), i.swipe && (m = i.swipe.call(qt, t, It, Dt, Rt, Qt), m === !1)) return !1;
                        switch (It) {
                        case s:
                            qt.trigger("swipeLeft", [It, Dt, Rt, Qt]), i.swipeLeft && (m = i.swipeLeft.call(qt, t, It, Dt, Rt, Qt));
                            break;
                        case n:
                            qt.trigger("swipeRight", [It, Dt, Rt, Qt]), i.swipeRight && (m = i.swipeRight.call(qt, t, It, Dt, Rt, Qt));
                            break;
                        case a:
                            qt.trigger("swipeUp", [It, Dt, Rt, Qt]), i.swipeUp && (m = i.swipeUp.call(qt, t, It, Dt, Rt, Qt));
                            break;
                        case o:
                            qt.trigger("swipeDown", [It, Dt, Rt, Qt]), i.swipeDown && (m = i.swipeDown.call(qt, t, It, Dt, Rt, Qt))
                        }
                    }
                }
                if (d == u) {
                    if (qt.trigger("pinchStatus", [c, Ht || null, Ot || 0, Rt || 0, Qt, Wt]), i.pinchStatus && (m = i.pinchStatus.call(qt, t, c, Ht || null, Ot || 0, Rt || 0, Qt, Wt), m === !1)) return !1;
                    if (c == k && H()) switch (Ht) {
                    case r:
                        qt.trigger("pinchIn", [Ht || null, Ot || 0, Rt || 0, Qt, Wt]), i.pinchIn && (m = i.pinchIn.call(qt, t, Ht || null, Ot || 0, Rt || 0, Qt, Wt));
                        break;
                    case l:
                        qt.trigger("pinchOut", [Ht || null, Ot || 0, Rt || 0, Qt, Wt]), i.pinchOut && (m = i.pinchOut.call(qt, t, Ht || null, Ot || 0, Rt || 0, Qt, Wt))
                    }
                }
                return d == p ? (c === x || c === k) && (clearTimeout(Gt), X() && !K() ? (Jt = _t(), Gt = setTimeout(e.proxy(function () {
                    Jt = null, qt.trigger("tap", [t.target]), i.tap && (m = i.tap.call(qt, t, t.target))
                }, this), i.doubleTapThreshold)) : (Jt = null, qt.trigger("tap", [t.target]), i.tap && (m = i.tap.call(qt, t, t.target)))) : d == f ? (c === x || c === k) && (clearTimeout(Gt), Jt = null, qt.trigger("doubletap", [t.target]), i.doubleTap && (m = i.doubleTap.call(qt, t, t.target))) : d == g && (c === x || c === k) && (clearTimeout(Gt), Jt = null, qt.trigger("longtap", [t.target]), i.longTap && (m = i.longTap.call(qt, t, t.target))), m
            }
            ...
            function O(e, t) {
                if (i.allowPageScroll === c || L()) e.preventDefault();
                else {
            ...
            function rt() {
                return !(qt.data(C + "_intouch") !== !0)
            }

            function lt(e) {
                e === !0 ? (qt.bind(Pt, $), qt.bind(jt, T), zt && qt.bind(zt, j)) : (qt.unbind(Pt, $, !1), qt.unbind(jt, T, !1), zt && qt.unbind(zt, j, !1)), qt.data(C + "_intouch", e === !0)
            }
            ...
            var $t = _ || !i.fallbackToMouseEvents,
                ...
                Gt = null;
            try {
                qt.bind(Tt, S), qt.bind(At, P)
            } catch (Kt) {
                e.error("events not supported " + Tt + "," + At + " on jQuery.swipe")
            }
            this.enable = function () {
                return qt.bind(Tt, S), qt.bind(At, P), qt
            }, this.disable = function () {
                return z(), qt
            }, this.destroy = function () {
                return z(), qt.data(C, null), qt
        ...
        var y = function () {
            ...
            z = function (e) {
                if ($(".product-swatches img").each(function () {
                    ...
                    }), "undefined" != typeof currentIndividualObj && (g = window.innerWidth, "undefined" == typeof f && (f = window.innerWidth), !(f > g && t === !1))) {
                    newSize = j();
