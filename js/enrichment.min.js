...
}), vidDescs = ['<h3 class="textBook">Alys Fowler | Garden Writer</h3><p class="textBook"></p>', '<h3 class="textBook">Tracy Chevalier | Novelist</h3><p class="textBook"></p>', '<h3 class="textBook">Dan Pearson | Garden Designer & Writer</h3><p class="textBook"></p>'], vidToPlay = 0;
